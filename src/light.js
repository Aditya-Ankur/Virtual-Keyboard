...
const copy = async (clipboardText) => {
  ...
  Swal.fire({
    toast: true,
    title: "<span style='color: white'>Copied Successfully</span>",
    icon: "success",
    timer: 1500,
  ...
  return (
    <>
      ...
      <div className="btn-light">
        <button id="light-to-home" type="button" onClick={() => push("/")}>
          <i class="fas fa-home"></i>
        </button>
      </div>
      <div className="btn-light">
        <button id="to-dark" type="button" onClick={() => push("/dark")}>
...
function Content() {
  ...
  const paste = async () => {
    await navigator.clipboard.readText().then((clipText) => {
      ...
      Swal.fire({
        toast: true,
        title: "<span style='color: white'>Pasted Successfully</span>",
        icon: "success",
        timer: 1500,
  ...
  const addText = (inputText) => {
    ...
    if (ctrl) {
      if (inputText.toLowerCase() === "c") {
        copy(text);
      } else if (inputText.toLowerCase() === "v") {
        paste();
      }
    } else if (capsLock) {
  ...
  return (
    <>
      ...
      >
        <table className="keyboard-light" cellSpacing="12" cellPadding="0">
            ...
            <td
              ...
              onClick={() => {
                ...
                Swal.fire({
                  toast: true,
                  title:
                    "<span style='color: white'>I have no idea what to do with this</span>",
                  icon: "warning",
                  timer: 1500,
                  background: "rgb(0, 0, 0, 0.99)",
                  timerProgressBar: true,
            ...
            <td
              ...
              onClick={() => {
                ...
                Swal.fire({
                  toast: true,
                  title:
                    "<span style='color: white'>I have no idea what to do with it</span>",
                  icon: "warning",
                  timer: 1500,
                  background: "rgb(0, 0, 0, 0.99)",
                  timerProgressBar: true,
